      ...
      <section id="contact" className="py-24 px-6 lg:px-12 max-w-6xl mx-auto scroll-mt-20">
        <div className="bg-white rounded-[3rem] shadow-xl shadow-stone-200/50 border border-stone-100 p-8 md:p-16 relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-14 relative z-10">
            ...
            <a href="mailto:pushpakumarawajira85@gmail.com" className="group bg-stone-50 p-8 md:p-10 rounded-[2rem] text-center border border-transparent hover:bg-white hover:border-emerald-100 hover:shadow-xl transition-all duration-300">
              <div className="w-14 h-14 bg-emerald-100 text-emerald-800 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:bg-emerald-800 group-hover:text-white transition-all duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                </svg>
              </div>
              <h4 className="text-xl font-serif text-emerald-950 mb-2">Email Us</h4>
              <p className="text-stone-600 font-medium break-all text-sm md:text-base">pushpakumarawajira85@gmail.com</p>
            </a>
